...
[GenomeView is completely open-source](https://github.com/GenomeView) and this allows you to write program that manipulate GenomeView or re-use parts of GenomeView, in particular the visualization component.
