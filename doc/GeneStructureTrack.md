...
### Colors
In the default configuration the following colors are used on the nucleotide band:

|Color|meaning|
|---|---|
|yellow|potential donor site|
|blue| potential acceptor site|
|green|potential start codon|
|red|[potential stop codon|
|light blue rectangle|visualize the structure of a gene in terms of strand and the phase of each exon|
